(function () {
    var h = {}, mt = {}, c = {
        id: "93888c4a36c82ca99c9f3d008e89dac6",
        dm: ["cn.jetli.com"],
    ...
    (mt.o.U = function () {
        ...
        (function () {
            if (!f)if (f = s, "complete" === document.readyState)a.w = s; else if (document.addEventListener)document.addEventListener("DOMContentLoaded",
            ...
            switch (typeof d) {
                ...
                default:
                    ...
                    if (d instanceof Array) {
                        ...
                        for (e = 0; e < k; e++)switch (l = d[e], typeof l) {
                            case "undefined":
                            case "function":
                            case "unknown":
                                break;
                            default:
                                n && f.push(","), f.push(mt.j.stringify(l)), n = 1
                        }
                        f.push("]");
                        return f.join("")
                    }
    ...
    var A = h.ga;
    h.B = {
        Na: "http://tongji.baidu.com/hm-web/welcome/ico",
        ...
        Fa: 1,
        K: 2147483647,
        W: "cc cf ci ck cl cm cp cu cw ds ep et fl ja ln lo lt nv rnd si st su v cv lv api u tt".split(" ")
    };
    (function () {
        var a = {
            l: {}, c: function (a, f) {
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!n || !l) && e && m)u = s, p = +new Date; else if (n && l && (!e || !m))u = w, q += +new Date - p;
            n = e;
            l = m;
            y = setTimeout(b, 100)
        }
    ...
    (function () {
        var a = mt.lang, b = h.B, f = h.load, d = {
            va: function (d) {
    ...
    (function () {
        ...
        var f = mt.lang, d = mt.j, g = h.B, k = h.D, n = h.ba, e = {
            p: [], z: 0, R: w, init: function () {
                e.e = 0;
                k.c("pv-b", function () {
                    e.ca();
                    e.ea()
                ...
                if (0 < e.p.length)for (var a = 0, b = e.p.length; a < b; a++)e.L(e.p[a]);
                e.p = t
            }, L: function (a) {
                var b = a[0];
                ...
                if (1 < a.length && (a = a[1], w === a || s === a))e.e |= 2, h.b.Q = a
                ...
                1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? g.protocol + "//" + window.location.host + a[1] : a[1], e.R = s)
                ...
                if (f.d(b, "Object")) {
                    ...
                    if (900 >= k)m.call(this, b); else for (var k = Math.ceil(k / 900), p = "block|" + Math.round(Math.random() *
                            g.K).toString(16) + "|" + k + "|", q = [], u = 0; u < k; u++)q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), m.call(this, p + q.join("|")), q = []
                }
    ...
    (function () {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = s, this.a = {}, this.Q = s, this.H = w, this.init())
        }

        var b = mt.url, f = mt.V, d = mt.N, g = mt.lang, k = mt.cookie, n = mt.h, e = mt.localStorage, l = mt.sessionStorage, m = h.B, v = h.D;
        a.prototype = {
            I: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                var a =
                    w;
                this.s(document.referrer) && this.s(document.location.href) ? a = s : (a = b.P(document.referrer), a = this.I(a || "", document.location.hostname));
                ...
                try {
                    k.set(a, b, {domain: this.G(), path: this.O(), F: d}), d ? e.set(a, b, d) : l.set(a, b)
                } catch (f) {
                }
            }, xa: function (a) {
                try {
                    k.set(a, "", {domain: this.G(), path: this.O(), F: -1}), l.remove(a), e.remove(a)
                } catch (b) {
                }
            }, Ca: function () {
                var a, b, d, f, e;
                ...
                try {
                    this.Da(),
                        0 === this.a.nv ? this.Aa() : this.M(".*"), h.b = this, this.aa(), v.r("pv-b"), this.za()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
                ...
                this.Q ? (this.H = s, this.a.et = 0, this.a.ep = "", this.g(a)) : a()
            }, g: function (a) {
                var b = this;
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), f = -1 < document.referrer.indexOf(m.Z), e = b.i(a, "jn"), g = /^heatlink$|^select$/.test(e);
                a && (d.test(a) && f && g) && (this.a.rnd = Math.round(Math.random() * m.K), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", m.protocol + "//" + c.js + e + ".js?" + this.a.rnd), e = document.getElementsByTagName("script")[0],
            ...
            Aa: function () {
                var a = this, b = l.get("Hm_unsent_" + c.id);
    ...
    (function () {
        var a = mt.o, b = mt.event, f = mt.url, d = mt.j;
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var e = function () {
                    ...
                    b = t;
                    if ("www.baidu.com" === l[2] || "m.baidu.com" === l[2])u = f.i(a, "qid"), b = f.i(a, "click_t");
                    a = u;
                    e.qid = a != t ? a : "";
                    b != t ? (e.bdDom = n ? n - b : 0, e.bdRun = g - b, e.bdDef = k("navigation").start - b) : (e.bdDom = 0, e.bdRun = 0, e.bdDef = 0);
                    h.b.a.et = 87;
    ...
    (function () {
        var a = mt.h, b = mt.lang, f = mt.event, d = mt.j;
        if ("undefined" !== typeof h.b && (c.med || (!a.wa || 7 < a.ua) && c.cvcc)) {
            var g, k, n, e, l = function (a) {
                ...
                e.v = a;
                if (f) {
                    var k = f.getAttribute("href"), l = f.getAttribute("onclick") ? "" + f.getAttribute("onclick") : t, m = f.getAttribute("id") || "";
            ...
            if (c.med)k = "/zoosnet", g = "swt", n = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, e = {
                click: function () {
    ...
    (function () {
        var a = mt.o, b = mt.lang, f = mt.event, d = mt.j;
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var g = {
                X: function () {
                    for (var b = c.cvcf.length, d, e = 0; e < b; e++)(d = a.ha(decodeURIComponent(c.cvcf[e]))) && f.c(d, "click", g.da())
                }, da: function () {
                    return function () {
                        h.b.a.et = 86;
                        var a = {n: "form", t: "clk"};
    ...
    (function () {
        ...
        if (c.med && "undefined" !== typeof h.b) {
            var f = +new Date, d = {n: "anti", sb: 0, kb: 0, clk: 0}, g = function () {
                h.b.a.et = 86;
